...
import './XD_CreationRoutine.dart';
...
class XD_Routineajoute extends StatelessWidget {
  XD_Routineajoute({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          // Adobe XD layer: 'Group Nouvelle rout…' (group)
          Stack(
            children: <Widget>[
              Transform.translate(
          ...
          PageLink(
            links: [
              PageLinkInfo(
                ...
                ease: Curves.easeOut,
                duration: 0.3,
                pageBuilder: () => XD_CreationRoutine(),
              ),
            ],
            child:
                // Adobe XD layer: 'Group Ajouter une r…' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(9.0, 769.0),
                  child: Container(
                    width: 396.0,
                    height: 63.0,
                    decoration: BoxDecoration(
