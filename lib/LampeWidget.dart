...
class LampeWidget extends StatefulWidget {
  LampeWidget({this.color1, this.color2, this.actualPiece});
  final Color color1;
  final Color color2;
  final actualPiece;
  @override
  _LampeWidgetState createState() => _LampeWidgetState();
}

class _LampeWidgetState extends State<LampeWidget> {
  bool _click = false;
  bool _fav = false;
