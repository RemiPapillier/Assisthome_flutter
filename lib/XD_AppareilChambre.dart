...
import './XD_burger_menu.dart';

class XD_AppareilChambre extends StatelessWidget {
  XD_AppareilChambre({
    Key key,
  }) : super(key: key);
  @override
                    ...
                    Transform.translate(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: const Color(0xffffffff),
                          border: Border.all(
                              width: 1.0, color: const Color(0xff7f8efe)),
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0x29000000),
                              offset: Offset(0, 3),
          ...
          Stack(
            children: <Widget>[
              ...
              Transform.translate(
                ...
                child:
                    // Adobe XD layer: 'noun_menu_1108888' (component)
                    XD_burger_menu(),
              ),
              Transform.translate(
